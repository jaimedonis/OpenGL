...
{   // ( std140 shader alignment rule requires each field bellow to be padded to 16 bytes )
    float material_type = PBRMaterialType::FlatMirror;
    glm::vec3 padding0;
    glm::vec4 subsurface_albedo = glm::vec4(M_PI * 1.5);
    glm::vec4 F0 = glm::vec4(0.045);
};
